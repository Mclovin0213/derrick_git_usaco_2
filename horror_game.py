...
def entity_dossiers():
    ...
    Entity 003: Grays°n
    Class: Striker
    Grays°n takes the form of an eye decal. If he is looked at, he will begin to teleport around the player, 
    rapidly draining their sanity. Grays°n takes around 3 shots to kill, but he is hard to kill due to his
    teleportation abilities. Grays°n is known to be able to cause anemoia, so beware. If he is taken down,
    he may drop his eye, which can be crafted into the Eyefestation Visor.
    '''
def level_dossiers():
